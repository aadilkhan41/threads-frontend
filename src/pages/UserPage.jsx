...
const UserPage = () => {
    ...
    useEffect(() => {
        axios.get(`https://threads-backend-tp0d.onrender.com/api/users/profile/${username}`, { withCredentials: true })
    ...
    return (
        <Box w="full">
            {(!isLoading && userProfile) && <UserHeader userProfile={userProfile} />}
