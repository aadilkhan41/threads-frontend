import { Stack, Flex, useToast, Box } from "@chakra-ui/react";
...
const LoginPage = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await axios.post("https://threads-backend-tp0d.onrender.com/api/users/login", loginBody, { withCredentials: true });
    ...
    return (
        <Box w="full">
            <form onSubmit={handleSubmit(onSubmit)}>
                <Flex w="full" direction="column" mt={10} gap={10} alignItems="center" justifyContent="center">
